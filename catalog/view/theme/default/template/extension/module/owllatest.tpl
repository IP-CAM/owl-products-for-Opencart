        ...
        <div class="product-thumb transition">
          ...
          <div class="image imghvr-zoom-in" style="background-color:#fff;">
            <img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" />
              <figcaption style="background-color:rgba(255,255,255,0.3);color:#444;">
                <p>
                  <button class="btn btn-primary" onclick="window.location='<?php echo $product['href']; ?>';"><i class="fa-eye fa"></i> <span> مشاهده</span></button>
                </p>
                <hr/>
                <button type="button" class="btn btn-primary" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i></button>
                <button type="button" class="btn btn-primary" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>
                <button type="button" class="btn btn-primary" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-exchange"></i></button>
              </figcaption>
          </div>
